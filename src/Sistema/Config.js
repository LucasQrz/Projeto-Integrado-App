  ...
  return (
    <View style={{flex: 1, backgroundColor: '#000000'}}>
      ...
      <View style={{flex: 9}}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', paddingLeft: 10, paddingTop: 20}}>
          <Ionicons name='options-outline' size={28} color='#fff'/>

          <View style={{flexDirection: 'column', paddingLeft: 15}}>
            <Text style={{color: '#fff', fontSize: 18}}>Geral</Text>
            <Text style={{color: '#B6B6B6', fontSize: 14}}>Idioma do aplicativo, notificações</Text>
          </View>
        </View>
      ...
      <View style={{flex: 1, justifyContent: 'flex-end'}}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', paddingLeft: 10, paddingBottom: 10}}>
